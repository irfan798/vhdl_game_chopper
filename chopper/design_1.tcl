...
irfan.atakan:ip:displaybuffer:1.2\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: displaybuffer_0, and set properties
  set displaybuffer_0 [ create_bd_cell -type ip -vlnv irfan.atakan:ip:displaybuffer:1.2 displaybuffer_0 ]
  set_property -dict [ list \
   CONFIG.OBJE_SAYISI {16} \
   CONFIG.UPSIZE {4} \
 ] $displaybuffer_0
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins displaybuffer_0/bram_doutb]
  connect_bd_net -net clk_wiz_0_pixelclock [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins clk_wiz_0/pixelclock] [get_bd_pins displaybuffer_0/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rgb2tmds_0/pixelclock] [get_bd_pins system_ila_0/clk] [get_bd_pins vtg_0/clk]
  connect_bd_net -net clk_wiz_0_serialclock [get_bd_pins clk_wiz_0/serialclock] [get_bd_pins rgb2tmds_0/serialclock]
  connect_bd_net -net displaybuffer_0_bram_dinb [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins displaybuffer_0/bram_dinb]
  connect_bd_net -net displaybuffer_0_bram_enb [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins displaybuffer_0/bram_enb]
  connect_bd_net -net displaybuffer_0_bram_rstb [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins displaybuffer_0/bram_rstb]
  connect_bd_net -net displaybuffer_0_bram_wenb [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins displaybuffer_0/bram_wenb]
  connect_bd_net -net displaybuffer_0_counter_out [get_bd_pins displaybuffer_0/counter_out] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net displaybuffer_0_obj_render_bit [get_bd_pins displaybuffer_0/obj_render_bit] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net displaybuffer_0_obj_x_out [get_bd_pins displaybuffer_0/obj_x_out] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net objectbuffer_0_bram_addrb [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins displaybuffer_0/bram_addrb]
  connect_bd_net -net objectbuffer_0_rgb [get_bd_pins displaybuffer_0/rgb] [get_bd_pins rgb2tmds_0/video_data] [get_bd_pins system_ila_0/probe5]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net vtg_0_hsync [get_bd_pins rgb2tmds_0/hsync] [get_bd_pins vtg_0/hsync]
  connect_bd_net -net vtg_0_pixel_x [get_bd_pins displaybuffer_0/pixel_x] [get_bd_pins system_ila_0/probe0] [get_bd_pins vtg_0/pixel_x]
  connect_bd_net -net vtg_0_pixel_y [get_bd_pins displaybuffer_0/pixel_y] [get_bd_pins system_ila_0/probe1] [get_bd_pins vtg_0/pixel_y]
  connect_bd_net -net vtg_0_video_active [get_bd_pins displaybuffer_0/video_active] [get_bd_pins rgb2tmds_0/video_active] [get_bd_pins vtg_0/video_active]
